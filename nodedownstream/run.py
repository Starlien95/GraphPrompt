...
train_config = {
    ...
    "max_nge": 2096,  # max_number_graph_edges: 256, 2048, 16384
    ...
    "graph_dir": "../data/PROTEINS/allraw",
    "save_data_dir": "../data/PROTEINS/all",
    "save_model_dir": "../dumps/debug",
    "save_pretrain_model_dir": "../dumps/PROTEINSPreTrain/GIN",
    "graphslabel_dir":"../data/debug/graphs",
    "downstream_graph_dir": "../data/debug/graphs",
    "downstream_save_data_dir": "../data/debug",
    "downstream_save_model_dir": "../dumps/PROTEINSNodeClassification/Prompt/GIN-FEATURE-WEIGHTED-SUM/all/1train1val10task",
    ...
    "save_fewshot_dir": "../data/PROTEINS/nodefewshot",
