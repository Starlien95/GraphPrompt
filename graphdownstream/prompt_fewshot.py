...
train_config = {
    ...
    "downstream_save_model_dir": "./dumps/PROTEINSGraphClassification/Prompt/GIN-FEATURE-WEIGHTED-SUM/5train5val100task",
    ...
    "save_fewshot_dir": "../data/PROTEINSGraphClassification/fewshot",
